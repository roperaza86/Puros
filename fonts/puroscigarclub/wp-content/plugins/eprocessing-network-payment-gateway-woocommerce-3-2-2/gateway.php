<?php
/*
Plugin Name: Electronic Processing Network Payment Gateway For WooCommerce
Description: Extends WooCommerce to Process Payments with Electronic Processing Network payment gateway
Version: 3.2.2
Plugin URI: http://pledgedplugins.com/products/eprocessing-network-payment-gateway-woocommerce/
Author: Pledged Plugins
Author URI: http://pledgedplugins.com/products/eprocessing-network-payment-gateway-woocommerce/
License: Under GPL2
   ...
   */
   class WC_Tech_Authoaim extends WC_Payment_Gateway 
   {
      ...
      public function __construct(){
         ...
         $this->method_title     = __('Electronic Processing Network', 'wc-tech-authoaim');
         ...
         $this->liveurl          = 'https://www.eProcessingNetwork.Com/cgi-bin/an/transact.pl';
         $this->testurl          = '';
         $this->msg['message']   = "";
         $this->msg['class']     = "";
      ...
      function init_form_fields()
      {
         ...
         $this->form_fields = array(
            ...
            'title'        => array(
                  ...
                  'default'      => __('Electronic Processing Network', 'wc-tech-authoaim')),
            'description'  => array(
                  ...
                  'default'      => __('Pay securely by Credit or Debit Card through Electronic Processing Network.', 'wc-tech-authoaim')),
            'login_id'     => array(
      ...
      **/
      ...
      {
         echo '<center><h3>'.__('Electronic Processing Network Payment Gateway', 'wc-tech-authoaim').'</h3>';
      ...
      **/
      function process_payment($order_id)
      {
         ...
         curl_setopt($request, CURLOPT_SSLVERSION, CURL_SSLVERSION_TLSv1_2); // version 1.2 required by epn by 9/1/15
