...
<div class="wrap netgo-admin-page-setting">
  ...
  <table class="wp-list-table widefat fixed striped pages">
   <tr>
	...
	<td colspan="2">
	<div align="right">
	 <form method="post" action="<?php echo get_option('home');?>/wp-admin/admin.php?page=tsaiospa-title-stats" id="posts-filter">  
  ...
  <table class="wp-list-table widefat fixed striped pages"> 
	...
	<thead>
	<tr>
	   <td width="50%"><strong><a class="class-to-<?php echo $classorder; ?>" href="<?php echo get_option('home');?>/wp-admin/admin.php?page=tsaiospa-title-stats&orderby=meta_value&order=<?php echo $ancorder; ?>"> Title</a></strong></td>
	...
	<tr>
	   ...
	   <?php  $post_cnt= tsaiospa_get_post_count( $kword);
...
<?php 
//pagination 
if (function_exists("tsaiospa_pagination")) {
?>
	<tr>
	   <td colspan="4">
	    <div  style="float:right;"><?php tsaiospa_pagination($the_query->max_num_pages); ?></div>
	   </td> 
	</tr>
<?php
} 
