...
class WC_Free_Gift_Coupons {
	...
	* @since 1.0
	...
	public static function admin_scripts() {
		...
		wp_register_script( 'woocommerce_free_gift_coupon_meta', plugins_url( 'assets/js/free-gift-coupon-meta-box' . $suffix . '.js' , __FILE__ ), false, self::$version );
...
?>
		...
		<?php if( self::is_woocommerce_2_3() ){ ?>
