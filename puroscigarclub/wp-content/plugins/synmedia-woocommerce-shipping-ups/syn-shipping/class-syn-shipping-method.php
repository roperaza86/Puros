				...
				<table class="wc_tax_rates widefat">
					<thead>
						<tr>
							...
							<th><?php _e( 'Price ajustment', 'syn_shipping' ); ?>&nbsp;<img class="help_tip" data-tip="<?php _e('Surcharge for this method, enter either a fixed amount (Ex.: 3.34) or a % amount (Ex.: 3.34%)', 'syn_shipping'); ?>" src="<?php echo( esc_url( $woocommerce->plugin_url() ) )?>/assets/images/help.png" height="16" width="16" /></th>
